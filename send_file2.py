...
EC2_IP = 'ec2-user@ec2-54-174-46-32.compute-1.amazonaws.com' # change to correct IP
KEY_PAIR_PATH = '../test_key_pair.pem' # change to PI's key-pair location

# to send data
AWS_DIR = '~/DepthMapping/Machine_Learning/'
FILE_SEND_PATH = './hello_world.py' # need to be change to whatever file
...
def fetch_file():
    ...
    print("getting the file from server")
